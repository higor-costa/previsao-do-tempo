...
function previsaoLocalizacao(latitude, longitude) {
    const urlApi = `https://api.hgbrasil.com/weather?format=json-cors&key=a0021980&lat=${latitude}&lon=${longitude}&user_ip=remote`
...
function pesquisaPorNome(cidade, estado) {
    const urlApi = `https://api.hgbrasil.com/weather?format=json-cors&key=a0021980&city_name=${cidade},${estado}`
